...
#define HOME_R HMT_2(KC_R)
#define HOME_S HMT_3(KC_S)
#define HOME_T HMT_4(KC_T)
...
#define HOME_N HMT_4(KC_N)
#define HOME_E HMT_3(KC_E)
#define HOME_I HMT_2(KC_I)
#define HOME_O HMT_1(KC_O)
