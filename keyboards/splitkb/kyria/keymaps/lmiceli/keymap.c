...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT(
    ...
    KC_F11,       LGUI_T(KC_A),  LALT_T(KC_R),  LCTL_T(KC_S),  LSFT_T(KC_T),  KC_G,  /*|*/  KC_M,  LSFT_T(KC_N),  LCTL_T(KC_E),  LALT_T(KC_I),  LGUI_T(KC_O),  KC_QUOT, 
    LGUI(KC_TAB), KC_Z,          KC_X,          KC_C,          KC_D,          KC_V,  /*|*/
                                                                    KC_MS_L, KC_MS_R,/*|*/KC_MS_D, KC_MS_U, 
                                                                                     /*|*/  KC_K,  KC_H,          KC_COMM,       KC_DOT,        KC_SLSH,       KC_WH_D,
                        KC_BTN2, KC_BTN1, LT(1,KC_ESC), LT(2,KC_BSPC), LT(3,KC_TAB), /*|*/  LT(4,KC_ENT),   LT(5,KC_SPC),   LT(6,KC_DEL),   KC_WH_L,   KC_WH_R
  ),
	[_SCREEN] = LAYOUT(
    KC_NO,   KC_NO, KC_BTN2,      KC_BTN3,    KC_BTN1,      KC_NO,                   /*|*/                KC_NO, SGUI(KC_L), SGUI(KC_U), SGUI(KC_Y), KC_MPRV, KC_MNXT, 
    KC_TRNS, KC_NO, MEH(KC_LEFT), MEH(KC_UP), MEH(KC_RGHT), KC_NO,                   /*|*/                KC_NO, SGUI(KC_N), SGUI(KC_E), SGUI(KC_I), KC_VOLD, KC_VOLU, 
    KC_NO,   KC_NO, KC_NO,        KC_NO,      KC_NO,        KC_NO,      KC_NO, KC_NO,/*|*/ KC_NO, KC_NO,  KC_NO, SGUI(KC_H), SGUI(KC_COMM), SGUI(KC_DOT), KC_MUTE, KC_MPLY, 
                                         KC_NO,   KC_NO, KC_NO,  KC_NO, KC_NO,       /*|*/     SGUI(KC_ENT), SGUI(KC_SPC), SGUI(KC_DEL), KC_NO, KC_NO
  ),
	
  [_ARROW] = LAYOUT(
    KC_NO,   LALT(KC_1), KC_BTN2, KC_BTN3, KC_BTN1, KC_NO,                           /*|*/ KC_PGUP, KC_HOME, KC_UP, KC_END, KC_PGDN, KC_NO, 
    LALT(KC_LEFT), KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, LALT(KC_RGHT),                /*|*/ LCA(KC_LEFT), KC_LEFT, KC_DOWN, KC_RGHT, LCA(KC_RGHT), KC_NO, 
    KC_NO, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_TAB), LSFT(KC_F6), KC_NO, /*|*/ KC_BTN1, KC_MS_U, KC_INS, LGUI(KC_LEFT), LGUI(KC_DOWN), LGUI(KC_UP), LGUI(KC_RGHT), KC_NO, 
    ...
    KC_TRNS, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, /*|*/ KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_TRNS, 
    ...
    KC_TRNS, KC_F11, KC_F4, KC_F5, KC_F6, KC_NO,                   /*|*/ KC_NO,   KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS, 
